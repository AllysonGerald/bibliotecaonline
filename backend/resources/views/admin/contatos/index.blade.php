            ...
            <table style="width: 100%; border-collapse: collapse;">
                ...
                <tbody>
                    @forelse($contacts as $contact)
                        <tr style="border-bottom: 2px solid #e0f2fe; transition: all 0.3s; {{ !$contact->lido ? 'background: linear-gradient(135deg, #fef3c7, #fef9c3);' : '' }}" onmouseover="this.style.background='linear-gradient(135deg, #f0f9ff, #e0f2fe)';" onmouseout="this.style.background='{{ !$contact->lido ? 'linear-gradient(135deg, #fef3c7, #fef9c3)' : 'transparent' }}';">
                            <td style="padding: 16px;">
                                ...
                                @else
                                    <span style="display: inline-block; padding: 6px 12px; border-radius: 8px; font-size: 12px; font-weight: 700; background: linear-gradient(135deg, #fef3c7, #fef9c3); color: #d97706; border: 2px solid #fde68a;">
                                        Não lida
                                    </span>
                                @endif
                            </td>
                        ...
                        <tr>
                            <td colspan="6" style="padding: 48px; text-align: center;">
                                <div style="width: 80px; height: 80px; background: linear-gradient(135deg, #e0f2fe, #f0f9ff); border-radius: 20px; display: flex; align-items: center; justify-content: center; margin: 0 auto 20px;">
                                    <i data-lucide="mail" style="width: 40px; height: 40px; color: #0ea5e9;"></i>
                                </div>
