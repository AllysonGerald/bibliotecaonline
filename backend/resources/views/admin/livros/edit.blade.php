    ...
    <div style="position: relative; z-index: 1;">
        <form method="POST" action="{{ route('admin.livros.update', $livro) }}" enctype="multipart/form-data">
            ...
            <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 24px;">
                ...
                <div style="grid-column: 1 / -1;">
                    ...
                    <input
                        ...
                        required
                        style="width: 100%; padding: 12px 16px; border: 2px solid {{ $errors->has('titulo') ? '#ef4444' : '#e9d5ff' }}; border-radius: 12px; font-size: 14px; transition: all 0.3s; background: linear-gradient(135deg, #faf5ff, #ffffff); box-sizing: border-box;"
                        onfocus="this.style.borderColor='#8b5cf6'; this.style.boxShadow='0 0 0 3px rgba(139, 92, 246, 0.1)';"
                        onblur="this.style.borderColor='{{ $errors->has('titulo') ? '#ef4444' : '#e9d5ff' }}'; this.style.boxShadow='none';"
                    >
                    @error('titulo')
                ...
                <div style="grid-column: 1 / -1;">
                    ...
                    <textarea
                        ...
                        rows="4"
                        required
                        style="width: 100%; padding: 12px 16px; border: 2px solid {{ $errors->has('descricao') ? '#ef4444' : '#e9d5ff' }}; border-radius: 12px; font-size: 14px; transition: all 0.3s; background: linear-gradient(135deg, #faf5ff, #ffffff); box-sizing: border-box; resize: vertical; font-family: inherit;"
                        onfocus="this.style.borderColor='#8b5cf6'; this.style.boxShadow='0 0 0 3px rgba(139, 92, 246, 0.1)';"
                        onblur="this.style.borderColor='{{ $errors->has('descricao') ? '#ef4444' : '#e9d5ff' }}'; this.style.boxShadow='none';"
                ...
                <div>
                    ...
                    <select
                        ...
                        id="autor_id"
                        required
                        style="width: 100%; padding: 12px 16px; border: 2px solid {{ $errors->has('autor_id') ? '#ef4444' : '#e9d5ff' }}; border-radius: 12px; font-size: 14px; transition: all 0.3s; background: linear-gradient(135deg, #faf5ff, #ffffff); cursor: pointer; box-sizing: border-box;"
                        onfocus="this.style.borderColor='#8b5cf6'; this.style.boxShadow='0 0 0 3px rgba(139, 92, 246, 0.1)';"
                        onblur="this.style.borderColor='{{ $errors->has('autor_id') ? '#ef4444' : '#e9d5ff' }}'; this.style.boxShadow='none';"
                    >
                ...
                <div>
                    ...
                    <select
                        ...
                        id="categoria_id"
                        required
                        style="width: 100%; padding: 12px 16px; border: 2px solid {{ $errors->has('categoria_id') ? '#ef4444' : '#e9d5ff' }}; border-radius: 12px; font-size: 14px; transition: all 0.3s; background: linear-gradient(135deg, #faf5ff, #ffffff); cursor: pointer; box-sizing: border-box;"
                        onfocus="this.style.borderColor='#8b5cf6'; this.style.boxShadow='0 0 0 3px rgba(139, 92, 246, 0.1)';"
                        onblur="this.style.borderColor='{{ $errors->has('categoria_id') ? '#ef4444' : '#e9d5ff' }}'; this.style.boxShadow='none';"
                    >
                ...
                <div>
                    ...
                    <input
                        ...
                        required
                        style="width: 100%; padding: 12px 16px; border: 2px solid {{ $errors->has('isbn') ? '#ef4444' : '#e9d5ff' }}; border-radius: 12px; font-size: 14px; transition: all 0.3s; background: linear-gradient(135deg, #faf5ff, #ffffff); box-sizing: border-box;"
                        onfocus="this.style.borderColor='#8b5cf6'; this.style.boxShadow='0 0 0 3px rgba(139, 92, 246, 0.1)';"
                        onblur="this.style.borderColor='{{ $errors->has('isbn') ? '#ef4444' : '#e9d5ff' }}'; this.style.boxShadow='none';"
                    >
                    @error('isbn')
                        <p style="margin-top: 8px; font-size: 13px; color: #ef4444; font-weight: 600;">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    ...
                    <input
                        ...
                        required
                        style="width: 100%; padding: 12px 16px; border: 2px solid {{ $errors->has('editora') ? '#ef4444' : '#e9d5ff' }}; border-radius: 12px; font-size: 14px; transition: all 0.3s; background: linear-gradient(135deg, #faf5ff, #ffffff); box-sizing: border-box;"
                        onfocus="this.style.borderColor='#8b5cf6'; this.style.boxShadow='0 0 0 3px rgba(139, 92, 246, 0.1)';"
                        onblur="this.style.borderColor='{{ $errors->has('editora') ? '#ef4444' : '#e9d5ff' }}'; this.style.boxShadow='none';"
                    >
                    @error('editora')
                        <p style="margin-top: 8px; font-size: 13px; color: #ef4444; font-weight: 600;">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    ...
                    <input
                        ...
                        min="1000"
                        max="{{ date('Y') }}"
                        style="width: 100%; padding: 12px 16px; border: 2px solid {{ $errors->has('ano_publicacao') ? '#ef4444' : '#e9d5ff' }}; border-radius: 12px; font-size: 14px; transition: all 0.3s; background: linear-gradient(135deg, #faf5ff, #ffffff); box-sizing: border-box;"
                        onfocus="this.style.borderColor='#8b5cf6'; this.style.boxShadow='0 0 0 3px rgba(139, 92, 246, 0.1)';"
                        onblur="this.style.borderColor='{{ $errors->has('ano_publicacao') ? '#ef4444' : '#e9d5ff' }}'; this.style.boxShadow='none';"
                    >
                ...
                <div>
                    ...
                    <input
                        ...
                        required
                        min="1"
                        style="width: 100%; padding: 12px 16px; border: 2px solid {{ $errors->has('paginas') ? '#ef4444' : '#e9d5ff' }}; border-radius: 12px; font-size: 14px; transition: all 0.3s; background: linear-gradient(135deg, #faf5ff, #ffffff); box-sizing: border-box;"
                        onfocus="this.style.borderColor='#8b5cf6'; this.style.boxShadow='0 0 0 3px rgba(139, 92, 246, 0.1)';"
                        onblur="this.style.borderColor='{{ $errors->has('paginas') ? '#ef4444' : '#e9d5ff' }}'; this.style.boxShadow='none';"
                    >
                    @error('paginas')
                        <p style="margin-top: 8px; font-size: 13px; color: #ef4444; font-weight: 600;">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    ...
                    <input
                        ...
                        min="0"
                        placeholder="0.00"
                        style="width: 100%; padding: 12px 16px; border: 2px solid {{ $errors->has('preco') ? '#ef4444' : '#e9d5ff' }}; border-radius: 12px; font-size: 14px; transition: all 0.3s; background: linear-gradient(135deg, #faf5ff, #ffffff); box-sizing: border-box;"
                        onfocus="this.style.borderColor='#8b5cf6'; this.style.boxShadow='0 0 0 3px rgba(139, 92, 246, 0.1)';"
                        onblur="this.style.borderColor='{{ $errors->has('preco') ? '#ef4444' : '#e9d5ff' }}'; this.style.boxShadow='none';"
                    >
                    @error('preco')
                        <p style="margin-top: 8px; font-size: 13px; color: #ef4444; font-weight: 600;">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    ...
                    <input
                        ...
                        required
                        min="0"
                        style="width: 100%; padding: 12px 16px; border: 2px solid {{ $errors->has('quantidade') ? '#ef4444' : '#e9d5ff' }}; border-radius: 12px; font-size: 14px; transition: all 0.3s; background: linear-gradient(135deg, #faf5ff, #ffffff); box-sizing: border-box;"
                        onfocus="this.style.borderColor='#8b5cf6'; this.style.boxShadow='0 0 0 3px rgba(139, 92, 246, 0.1)';"
                        onblur="this.style.borderColor='{{ $errors->has('quantidade') ? '#ef4444' : '#e9d5ff' }}'; this.style.boxShadow='none';"
                    >
                    @error('quantidade')
                        <p style="margin-top: 8px; font-size: 13px; color: #ef4444; font-weight: 600;">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    ...
                    @if($livro->imagem_capa)
                        <div style="margin-bottom: 12px;">
                            <img src="{{ asset('storage/' . $livro->imagem_capa) }}" alt="Capa atual" style="max-height: 120px; width: auto; border-radius: 12px; border: 2px solid #e9d5ff;">
                        </div>
                    @endif
                    <input
                        type="file"
                        ...
                        id="imagem_capa"
                        accept="image/*"
                        style="width: 100%; padding: 12px 16px; border: 2px solid {{ $errors->has('imagem_capa') ? '#ef4444' : '#e9d5ff' }}; border-radius: 12px; font-size: 14px; transition: all 0.3s; background: linear-gradient(135deg, #faf5ff, #ffffff); box-sizing: border-box; cursor: pointer;"
                        onfocus="this.style.borderColor='#8b5cf6'; this.style.boxShadow='0 0 0 3px rgba(139, 92, 246, 0.1)';"
                        onblur="this.style.borderColor='{{ $errors->has('imagem_capa') ? '#ef4444' : '#e9d5ff' }}'; this.style.boxShadow='none';"
                    >
                    @error('imagem_capa')
                        <p style="margin-top: 8px; font-size: 13px; color: #ef4444; font-weight: 600;">{{ $message }}</p>
                    @enderror
                ...
                <div style="grid-column: 1 / -1;">
                    ...
                    <div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(150px, 1fr)); gap: 12px; padding: 20px; background: linear-gradient(135deg, #faf5ff, #f3e8ff); border: 2px solid #e9d5ff; border-radius: 12px;">
                        @foreach($tags as $tag)
            ...
            <div style="margin-top: 32px; display: flex; justify-content: flex-end; gap: 12px; flex-wrap: wrap;">
                <a href="{{ route('admin.livros.index') }}" style="display: inline-flex; align-items: center; padding: 12px 24px; background: linear-gradient(135deg, #f3e8ff, #faf5ff); color: #8b5cf6; border: 3px solid #e9d5ff; border-radius: 12px; font-size: 14px; font-weight: 700; text-decoration: none; transition: all 0.3s; box-shadow: 0 4px 10px rgba(139, 92, 246, 0.15);" onmouseover="this.style.background='linear-gradient(135deg, #8b5cf6, #a855f7)'; this.style.color='white'; this.style.borderColor='#8b5cf6'; this.style.transform='translateY(-2px)'; this.style.boxShadow='0 6px 15px rgba(139, 92, 246, 0.3)';" onmouseout="this.style.background='linear-gradient(135deg, #f3e8ff, #faf5ff)'; this.style.color='#8b5cf6'; this.style.borderColor='#e9d5ff'; this.style.transform='translateY(0)'; this.style.boxShadow='0 4px 10px rgba(139, 92, 246, 0.15)';">
                    Cancelar
                </a>
