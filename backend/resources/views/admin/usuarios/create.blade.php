...
<div style="margin-bottom: 32px;">
    <div style="display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 16px;">
        <div>
            <h1 style="font-size: 36px; font-weight: 900; color: #1f2937; margin-bottom: 8px;">Novo Usuário</h1>
            <p style="font-size: 18px; color: #6b7280; font-weight: 500;">Crie um novo usuário no sistema</p>
        </div>
    ...
    <div style="position: relative; z-index: 1;">
        <form method="POST" action="{{ route('admin.usuarios.store') }}">
            ...
            <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 24px;">
                ...
                <div>
                    <label for="password" style="display: block; font-size: 14px; font-weight: 700; color: #6b7280; margin-bottom: 8px;">Senha *</label>
                    <input
                        type="password"
                        name="password"
                        id="password"
                ...
                <div>
                    <label for="password_confirmation" style="display: block; font-size: 14px; font-weight: 700; color: #6b7280; margin-bottom: 8px;">Confirmar Senha *</label>
                    <input
                        type="password"
